...
from pathiel.agents.book_helpers import execute_block_detail as _execute_block_detail
from pathiel.agents.book_helpers import execute_opened as _execute_opened
from pathiel.agents.book_helpers import last_pass_ms, load_seen, mark_pass, save_seen
from pathiel.agents.news_catalyst import CatalystReport, coin_catalyst
from pathiel.agents.rebalancer_owned import get_claims_registry, state_file
from pathiel.agents.rebalancer_owned import held_coins_with_dsl as _held_coins
from pathiel.models.types import BookAnalysis
from pathiel.session_log import append as log_event
from pathiel.agents.book_params import FLOOR_LEVERAGE, FLOOR_NOTIONAL_USD, FLOOR_STOP_PCT, book_params
...
def _macro_regime(coin: str) -> Optional[str]:
    ...
    """
    try:
        from pathiel.agents.market_regime import (
